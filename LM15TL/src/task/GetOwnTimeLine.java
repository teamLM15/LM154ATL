...
public class GetOwnTimeLine extends AbstractGetTimelineTask {

	private Paging paging;
	private SwipeRefreshLayout mSwipeRefreshLayout;

	public GetOwnTimeLine(ArrayList<TwitterStatusData> items,
	...
	protected Object doInBackground(Twitter... twitter) {
		...
		try {
			responseList = twitter[0].getUserTimeline(twitter[0].getId(),
					paging);
